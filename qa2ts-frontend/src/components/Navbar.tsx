...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="navbar h-16 fixed top-0 left-0 w-full z-50">
        <div className="max-w-7xl px-[5%] h-full flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6">
            <ul className="flex gap-6">
              ...
              <li><Link to="https://github.com/qway-tech/qa2ts-brasil" className="navbar-link">Repositório</Link></li>
              {user && (
                <>
                  <li><Link to="/quiz" className="navbar-link">Quizzes</Link></li>
                  <li><Link to="/prova" className="navbar-link">Provas</Link></li>
                </>
              )}
            </ul>
            <ProfileMenu />
          ...
          <ul className="flex flex-col gap-4 items-end">
            ...
            {user && (
              ...
              {!user ? (
                ...
                <li>
                  <ProfileMenu onNavigate={() => setIsMobileMenuOpen(false)} />
                </li>
              )}
          </ul>
        </div>
